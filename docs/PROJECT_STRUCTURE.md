...
- `web`: painel PWA preservado do repositório, com dependências e build próprios.
- `design/handoff`: materiais de design preservados para consulta; não entram no bundle mobile.
